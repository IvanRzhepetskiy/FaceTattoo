"""
import Augmentor
p = Augmentor.Pipeline('./images_aug')
#p.gaussian_distortion(probability=1, grid_width=5, grid_height=5, magnitude=5, corner='bell', method='out')
p.skew_tilt(1, magnitude=0.5)
p.process()
"""
